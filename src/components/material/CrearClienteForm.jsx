// src/components/CrearClienteForm.jsx
...
import { registrarCliente } from "../../utils/registrarCliente";
import { useSnackbar } from "notistack";

export default function CrearClienteForm({ onExito }) {
  ...
  const handleSubmit = async (e) => {
    ...
    setLoading(true);
    try {
      await registrarCliente(formData); // crea usuario con password "123456"
